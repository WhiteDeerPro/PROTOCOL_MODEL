        ...
        if event.trace_index is None:
            return SemanticStep(
                ...
                fault=SemanticFault(
                    ...
                    "stream transfers must be normalized by an InterfaceSession",
                    ConstraintScope.INTERFACE,
                ),
            )
...
def build_axi4_stream_interface(
    config: Axi4StreamConfig | None = None,
) -> InterfaceProtocol:
    """Build the base AXI4-Stream InterfaceProtocol.
    ...
    fragment = SemanticFragment(
        "axi4_stream.interface_semantics",
        constraints=(
            SemanticConstraint(
    ...
    return InterfaceProtocol.define(
        "axi4_stream",
        interface_family=AXI4_STREAM_FAMILY,
        roles=frozenset(("transmitter", "receiver")),
        event_kinds={"T": channel},
        fragments=(fragment,),
        parameters={
...
def build_axi4_stream_continuous_profile(
    ...
    base = build_axi4_stream_interface(config)
