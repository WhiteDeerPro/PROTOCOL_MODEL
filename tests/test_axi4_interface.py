...
from protocol_model.artifacts import protocol_record_from_interface
from protocol_model.protocols.amba.axi.axi4 import (
    ...
    build_axi4_read_interface,
)
from protocol_model.semantics import EventOffer, Verdict


class Axi4ReadInterfaceTest(unittest.TestCase):
    def test_monitor_offers_only_enabled_read_actions(self) -> None:
        protocol = build_axi4_read_interface()
    ...
    def test_generated_trace_is_accepted_by_the_same_interface_protocol(self) -> None:
        protocol = build_axi4_read_interface()
...
class Axi4WriteInterfaceTest(unittest.TestCase):
    def test_generated_writes_are_accepted_by_the_five_channel_interface(self) -> None:
        protocol = build_axi4_interface()
...
class Axi4ResourceLifecycleTest(unittest.TestCase):
    def test_interface_declares_unbounded_transaction_resource_lifecycles(self) -> None:
        protocol = build_axi4_interface()
    ...
    def test_protocol_record_exposes_resource_lifecycle(self) -> None:
        record = protocol_record_from_interface(build_axi4_interface())
        self.assertEqual("interface", record.scope)
        resources = {
    ...
    def test_bounded_profile_rejects_resource_overflow_and_rolls_back(self) -> None:
        protocol = build_axi4_interface().with_resource_capacities(
            "axi4_one_read",
