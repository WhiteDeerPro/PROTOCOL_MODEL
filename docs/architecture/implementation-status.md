...
- CHI Issue H 已完成构造依赖、判定作用域与表示/运输三张视图的边界审计，并有受限 direct-Home
  ...
  串行化；WriteBack 同址 Snoop/cancel、等待者合并/优先级和一般多 Requester resolved topology 仍未闭合。
