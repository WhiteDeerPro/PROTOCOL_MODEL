"""Native AXI4-Lite schemas and single-interface transaction semantics."""
...
from protocol_model.protocols.amba.byte_lanes import transfer_container_lane_mask
from protocol_model.protocols.amba.axi.axi4.write import Axi4WriteMonitor
...
def build_axi4_lite_interface(config: Axi4LiteConfig | None = None) -> InterfaceProtocol:
    """Build the native five-channel AXI4-Lite InterfaceProtocol.
    ...
    return InterfaceProtocol.define(
        "axi4_lite",
        interface_family=AXI4_LITE_FAMILY,
