"""AXI4 interface-local exclusive access sequencing and response semantics."""
...
class Axi4ExclusiveMonitor(
    ...
    """Check the exclusive relations decidable from one AXI4 interface trace.
    ...
    remains legal; invalidation by traffic on other interface connections belongs to the
