...
from protocol_model.protocols.amba.axi.axi4 import Axi4Config
...
class Axi4LiteToAxi4:
    ...
    def trace(self, trace: InterfaceTrace) -> InterfaceTrace:
        return InterfaceTrace(tuple(self.event(event) for event in trace.events), trace.causal_edges)
