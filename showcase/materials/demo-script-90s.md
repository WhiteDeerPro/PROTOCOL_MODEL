...
录制前必须核对[当前实现状态](../../docs/architecture/implementation-status.md)和
[AXI4 示例导航](../generated/axi4/README.zh-CN.md)。统一 AXI4 介绍集当前包含 24 个
...
| 8–21s | 三个简洁方框依次出现：Link、Module、System | **旁白：**“InterfaceProtocol 说明一条连接上允许怎样通信；VirtualDut 说明一个具体 module 怎样响应；SystemProtocol 说明多个 module 接起来后整体要满足什么。” | CURRENT |
...
| 8–21s | Three clean blocks appear: Link, Module, System | **Voice-over:** “A InterfaceProtocol defines legal communication on one connection. A VirtualDut describes how one concrete module responds. A SystemProtocol states what must hold after modules are connected.” | CURRENT |
