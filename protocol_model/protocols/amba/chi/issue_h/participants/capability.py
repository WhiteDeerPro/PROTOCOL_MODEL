...
CHI_REQUESTER_CLEAN_DCT_COMP_DATA_ACCEPT = ChiCapabilityKey(
    "chi.requester.clean_dct.comp_data.accept"
)
CHI_HOME_SNP_SHARED_FWD_PRODUCE = ChiCapabilityKey(
    "chi.home.snp_shared_fwd.produce"
)
CHI_HOME_SNP_RESP_FWDED_ACCEPT = ChiCapabilityKey(
    "chi.home.snp_resp_fwded.accept"
)
CHI_HOME_CLEAN_DCT_JOIN = ChiCapabilityKey(
    "chi.home.clean_dct.join"
)
CHI_SNOOPEE_SNP_SHARED_FWD_ACCEPT = ChiCapabilityKey(
    "chi.snoopee.snp_shared_fwd.accept"
)
CHI_SNOOPEE_CLEAN_DCT_COMP_DATA_PRODUCE = ChiCapabilityKey(
    "chi.snoopee.clean_dct.comp_data.produce"
)
CHI_SNOOPEE_SNP_RESP_FWDED_PRODUCE = ChiCapabilityKey(
    "chi.snoopee.snp_resp_fwded.produce"
)
...
CHI_REQUESTER_WRITE_NO_SNP_FULL_ISSUE = ChiCapabilityKey(
    "chi.requester.write_no_snp_full.issue"
)
CHI_REQUESTER_WRITE_NO_SNP_PTL_ISSUE = ChiCapabilityKey(
    "chi.requester.write_no_snp_ptl.issue"
)
CHI_REQUESTER_NON_COPYBACK_WR_DATA_PRODUCE = ChiCapabilityKey(
    "chi.requester.non_copyback_wr_data.produce"
)
CHI_HOME_WRITE_NO_SNP_FULL_ACCEPT = ChiCapabilityKey(
    "chi.home.write_no_snp_full.accept"
)
CHI_HOME_WRITE_NO_SNP_PTL_ACCEPT = ChiCapabilityKey(
    "chi.home.write_no_snp_ptl.accept"
)
CHI_HOME_NON_COPYBACK_WR_DATA_ACCEPT = ChiCapabilityKey(
    "chi.home.non_copyback_wr_data.accept"
)
CHI_HOME_NON_COPYBACK_WRITE_COMMIT = ChiCapabilityKey(
    "chi.home.non_copyback_write.commit"
)
CHI_REQUESTER_ATOMIC_SWAP_ISSUE = ChiCapabilityKey(
    "chi.requester.atomic_swap.issue"
)
CHI_REQUESTER_ATOMIC_LOAD_ADD_ISSUE = ChiCapabilityKey(
    "chi.requester.atomic_load_add.issue"
)
CHI_REQUESTER_DBID_RESP_ACCEPT = ChiCapabilityKey(
    "chi.requester.dbid_resp.accept"
)
CHI_REQUESTER_ATOMIC_SWAP_COMP_DATA_ACCEPT = ChiCapabilityKey(
    "chi.requester.atomic_swap.comp_data.accept"
)
CHI_REQUESTER_ATOMIC_LOAD_ADD_COMP_DATA_ACCEPT = ChiCapabilityKey(
    "chi.requester.atomic_load_add.comp_data.accept"
)
CHI_HOME_ATOMIC_SWAP_ACCEPT = ChiCapabilityKey(
    "chi.home.atomic_swap.accept"
)
CHI_HOME_ATOMIC_LOAD_ADD_ACCEPT = ChiCapabilityKey(
    "chi.home.atomic_load_add.accept"
)
CHI_HOME_DBID_RESP_PRODUCE = ChiCapabilityKey(
    "chi.home.dbid_resp.produce"
)
CHI_HOME_ATOMIC_SWAP_EXECUTE_RETURN = ChiCapabilityKey(
    "chi.home.atomic_swap.execute_and_return_original"
)
CHI_HOME_ATOMIC_LOAD_ADD_EXECUTE_RETURN = ChiCapabilityKey(
    "chi.home.atomic_load_add.execute_and_return_original"
)
CHI_REQUESTER_NON_SNOOP_EXCLUSIVE_READ_ISSUE = ChiCapabilityKey(
    "chi.requester.non_snoop_exclusive.read.issue"
)
CHI_REQUESTER_NON_SNOOP_EXCLUSIVE_COMP_DATA_ACCEPT = ChiCapabilityKey(
    "chi.requester.non_snoop_exclusive.comp_data.accept"
)
CHI_REQUESTER_NON_SNOOP_EXCLUSIVE_WRITE_PTL_ISSUE = ChiCapabilityKey(
    "chi.requester.non_snoop_exclusive.write_no_snp_ptl.issue"
)
CHI_REQUESTER_NON_SNOOP_EXCLUSIVE_COMP_DBID_RESP_ACCEPT = ChiCapabilityKey(
    "chi.requester.non_snoop_exclusive.comp_dbid_resp.accept"
)
CHI_HOME_NON_SNOOP_EXCLUSIVE_READ_ACCEPT = ChiCapabilityKey(
    "chi.home.non_snoop_exclusive.read.accept"
)
CHI_HOME_NON_SNOOP_EXCLUSIVE_COMP_DATA_PRODUCE = ChiCapabilityKey(
    "chi.home.non_snoop_exclusive.comp_data.produce"
)
CHI_HOME_NON_SNOOP_EXCLUSIVE_MONITOR = ChiCapabilityKey(
    "chi.home.non_snoop_exclusive.system_monitor"
)
CHI_HOME_NON_SNOOP_EXCLUSIVE_WRITE_PTL_ACCEPT = ChiCapabilityKey(
    "chi.home.non_snoop_exclusive.write_no_snp_ptl.accept"
)
CHI_HOME_NON_SNOOP_EXCLUSIVE_COMP_DBID_RESP_PRODUCE = ChiCapabilityKey(
    "chi.home.non_snoop_exclusive.comp_dbid_resp.produce"
)
CHI_HOME_NON_SNOOP_EXCLUSIVE_CONDITIONAL_COMMIT = ChiCapabilityKey(
    "chi.home.non_snoop_exclusive.conditional_commit"
)
...
CHI_CLEAN_READ_SHARED_DCT_REQUESTER_CAPABILITIES = frozenset(
    (CHI_REQUESTER_CLEAN_DCT_COMP_DATA_ACCEPT,)
)
CHI_CLEAN_READ_SHARED_DCT_HOME_CAPABILITIES = frozenset(
    (
        CHI_HOME_SNP_SHARED_FWD_PRODUCE,
        CHI_HOME_SNP_RESP_FWDED_ACCEPT,
        CHI_HOME_CLEAN_DCT_JOIN,
    )
)
CHI_CLEAN_READ_SHARED_DCT_SNOOPEE_CAPABILITIES = frozenset(
    (
        CHI_SNOOPEE_SNP_SHARED_FWD_ACCEPT,
        CHI_SNOOPEE_CLEAN_DCT_COMP_DATA_PRODUCE,
        CHI_SNOOPEE_SNP_RESP_FWDED_PRODUCE,
    )
)
...
CHI_WRITE_NO_SNP_FULL_REQUESTER_CAPABILITIES = frozenset(
    (
        CHI_REQUESTER_WRITE_NO_SNP_FULL_ISSUE,
        CHI_REQUESTER_COMP_DBID_RESP_ACCEPT,
        CHI_REQUESTER_NON_COPYBACK_WR_DATA_PRODUCE,
    )
)
CHI_WRITE_NO_SNP_FULL_HOME_CAPABILITIES = frozenset(
    (
        CHI_HOME_WRITE_NO_SNP_FULL_ACCEPT,
        CHI_HOME_COMP_DBID_RESP_PRODUCE,
        CHI_HOME_NON_COPYBACK_WR_DATA_ACCEPT,
        CHI_HOME_NON_COPYBACK_WRITE_COMMIT,
    )
)
CHI_WRITE_NO_SNP_PTL_REQUESTER_CAPABILITIES = frozenset(
    (
        CHI_REQUESTER_WRITE_NO_SNP_PTL_ISSUE,
        CHI_REQUESTER_COMP_DBID_RESP_ACCEPT,
        CHI_REQUESTER_NON_COPYBACK_WR_DATA_PRODUCE,
    )
)
CHI_WRITE_NO_SNP_PTL_HOME_CAPABILITIES = frozenset(
    (
        CHI_HOME_WRITE_NO_SNP_PTL_ACCEPT,
        CHI_HOME_COMP_DBID_RESP_PRODUCE,
        CHI_HOME_NON_COPYBACK_WR_DATA_ACCEPT,
        CHI_HOME_NON_COPYBACK_WRITE_COMMIT,
    )
)
CHI_ATOMIC_SWAP_REQUESTER_CAPABILITIES = frozenset(
    (
        CHI_REQUESTER_ATOMIC_SWAP_ISSUE,
        CHI_REQUESTER_DBID_RESP_ACCEPT,
        CHI_REQUESTER_NON_COPYBACK_WR_DATA_PRODUCE,
        CHI_REQUESTER_ATOMIC_SWAP_COMP_DATA_ACCEPT,
    )
)
CHI_ATOMIC_SWAP_HOME_CAPABILITIES = frozenset(
    (
        CHI_HOME_ATOMIC_SWAP_ACCEPT,
        CHI_HOME_DBID_RESP_PRODUCE,
        CHI_HOME_NON_COPYBACK_WR_DATA_ACCEPT,
        CHI_HOME_ATOMIC_SWAP_EXECUTE_RETURN,
    )
)
CHI_ATOMIC_LOAD_ADD_REQUESTER_CAPABILITIES = frozenset(
    (
        CHI_REQUESTER_ATOMIC_LOAD_ADD_ISSUE,
        CHI_REQUESTER_DBID_RESP_ACCEPT,
        CHI_REQUESTER_NON_COPYBACK_WR_DATA_PRODUCE,
        CHI_REQUESTER_ATOMIC_LOAD_ADD_COMP_DATA_ACCEPT,
    )
)
CHI_ATOMIC_LOAD_ADD_HOME_CAPABILITIES = frozenset(
    (
        CHI_HOME_ATOMIC_LOAD_ADD_ACCEPT,
        CHI_HOME_DBID_RESP_PRODUCE,
        CHI_HOME_NON_COPYBACK_WR_DATA_ACCEPT,
        CHI_HOME_ATOMIC_LOAD_ADD_EXECUTE_RETURN,
    )
)
CHI_NON_SNOOP_EXCLUSIVE_PTL_REQUESTER_CAPABILITIES = frozenset(
    (
        CHI_REQUESTER_NON_SNOOP_EXCLUSIVE_READ_ISSUE,
        CHI_REQUESTER_NON_SNOOP_EXCLUSIVE_COMP_DATA_ACCEPT,
        CHI_REQUESTER_NON_SNOOP_EXCLUSIVE_WRITE_PTL_ISSUE,
        CHI_REQUESTER_NON_SNOOP_EXCLUSIVE_COMP_DBID_RESP_ACCEPT,
        CHI_REQUESTER_NON_COPYBACK_WR_DATA_PRODUCE,
    )
)
CHI_NON_SNOOP_EXCLUSIVE_PTL_HOME_CAPABILITIES = frozenset(
    (
        CHI_HOME_NON_SNOOP_EXCLUSIVE_READ_ACCEPT,
        CHI_HOME_NON_SNOOP_EXCLUSIVE_COMP_DATA_PRODUCE,
        CHI_HOME_NON_SNOOP_EXCLUSIVE_MONITOR,
        CHI_HOME_NON_SNOOP_EXCLUSIVE_WRITE_PTL_ACCEPT,
        CHI_HOME_NON_SNOOP_EXCLUSIVE_COMP_DBID_RESP_PRODUCE,
        CHI_HOME_NON_COPYBACK_WR_DATA_ACCEPT,
        CHI_HOME_NON_SNOOP_EXCLUSIVE_CONDITIONAL_COMMIT,
    )
)
