...
我们正在准备 Protocol Model 的首轮 technical preview，并已经完成第一个可执行切片。它是一个面向片上通信
...
进一步阅读：[统一 AXI4 示例](../generated/axi4/README.zh-CN.md) · [项目介绍](one-pager.zh-CN.md) · [演示编排策略](../strategy/demo-program.md) ·
