...
CHI_MODULES = (
    ...
    "tests.test_chi_issue_h_make_unique_participants",
    "tests.test_chi_issue_h_make_unique_system",
    "tests.test_chi_issue_h_multi_requester_coherence",
    ...
    "tests.test_chi_issue_h_write_evict_full_copy_at_home_capability",
    "tests.test_chi_issue_h_write_evict_full_copy_at_home_participants",
    "tests.test_chi_issue_h_write_evict_full_copy_at_home_system",
...
VIRTUAL_DUT_MODULES = (
    ...
    "tests.test_virtual_dut_line_backing",
