...
- CHI Issue H 已完成构造依赖、判定作用域与表示/运输三张视图的边界审计，并有受限 direct-Home
  ...
  deliberate dirty invalidate、WriteEvictFull CAH/Snoop/error modifier、`WriteEvictOrEvict`、一般 `SD`
