...
- CHI Issue H 已完成构造依赖、判定作用域与表示/运输三张视图的边界审计，并有受限 direct-Home
  ...
  reference backing 不变。Home attach/canonical binder 已用独立
  ...
  WriteEvictOrEvict same-line-Snoop/Retry/error 与容量驱动 outcome policy、一般 `SD`
