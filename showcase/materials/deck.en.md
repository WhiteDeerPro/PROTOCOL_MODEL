...
<small>Status: CURRENT — see implementation-status for boundaries; this is not a complete compliance claim.</small>
...
**In integration:** moving the full AXI4-to-APB bridge onto an attachment-aware shared executor.
...
[Implementation boundary](../../docs/architecture/implementation-status.md) ·
[AXI4 examples](../generated/axi4/README.en.md)
