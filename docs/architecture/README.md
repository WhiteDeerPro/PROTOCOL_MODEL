...
| bridge、typed Transform | [Bridge 与事务转译](typed-transaction-translation.md) | [跨领域设计启示](bridge-construction-insights.md)、[V1 实施计划](translation-v1-plan.md) |
