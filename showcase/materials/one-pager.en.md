...
**technical preview in preparation, with an executable first slice**: scan one 24-case navigation, inspect the waveform
...
[current implementation boundary](../../docs/architecture/migration-status.md) ·
