"""Canonical-event AXI4 InterfaceProtocol definitions."""
...
def build_axi4_read_interface(config: Axi4Config | None = None) -> InterfaceProtocol:
...
def build_axi4_interface(config: Axi4Config | None = None) -> InterfaceProtocol:
    """Build the current five-channel AXI4 canonical-event model."""

    config = config or Axi4Config()
    read = build_axi4_read_interface(config)
    channels = {
